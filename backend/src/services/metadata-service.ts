  ...
  const variants: PersistableVariant[] = [
    {
      ...
      caption: clipText(`Have you ever noticed this about ${keywordPool[0] ?? "this topic"}? Watch until the end to see why ${asset.title} completely changes the game. 👇`, 160),
    ...
    },
    {
      ...
      caption: clipText(`Here is the exact framework I use for ${keywordPool[0] ?? "this strategy"}. ${asset.title} breaks down the step-by-step process. Save this for later! 📌`, 160),
    ...
    },
    {
      ...
      caption: clipText(`Most people are completely wrong about ${keywordPool[0] ?? "this"}. Here is the truth about ${asset.title}. Drop your thoughts in the comments! 🗣️`, 160),
